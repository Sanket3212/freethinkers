        ...
        <div v-if="!zoomedIn">
          <div class="row">
            <div class="col-6">
              ...
              <div class="graph-container">
                <iframe
                src="http://localhost:3000/d-solo/eduwksm148dtsa/flowmeter2?orgId=1&from=1685557800000&to=1688149799000&panelId=2"
                  width="100%"
                  height="200"
                  frameborder="0"
            ...
            <div class="col-6">
              <div class="graph-container">
                <iframe
                src="http://localhost:3000/d-solo/eduwksm148dtsa/flowmeter2?orgId=1&from=1685557800000&to=1688149799000&panelId=1" 
                  width="100%"
                  height="200"
                  frameborder="0"
    ...
    methods: {
      ...
      loadData() {
        fetch('/src/assets/data.json')
          ...
          .then((data) => {
            this.data = data.map((d) => +d['field4']);
            this.categories = data.map((d) => d['Flowmeter 2']);
