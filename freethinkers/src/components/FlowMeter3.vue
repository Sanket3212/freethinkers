          ...
          <div class="row">
            <div class="col-6">
              <div class="graph-container">
                <iframe
                src="http://localhost:3000/d-solo/cdtzkeuurnoqoc/flowmeter1?orgId=1&from=1683492212138&to=1684132683830&panelId=19" 
                  width="100%"
                  height="200"
                  frameborder="0"
              ...
              <div class="graph-container">
                <iframe
                src="http://localhost:3000/d-solo/fduwmz29yai2ob/flowmeter3?orgId=1&from=1685557800000&to=1688149799000&panelId=2"
                  width="100%"
                  height="200"
                  frameborder="0"
            ...
            <div class="col-6">
              <div class="graph-container">
                <iframe
                src="http://localhost:3000/d-solo/fduwmz29yai2ob/flowmeter3?orgId=1&from=1685557800000&to=1688149799000&panelId=1" 
                  width="100%"
                  height="200"
                  frameborder="0"
